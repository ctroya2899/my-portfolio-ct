...
const stats = [
  ...
  { value: "97%", label: "Process Time Reduction" },
  { value: "700+", label: "Automated Reports Weekly" },
  { value: "100+", label: "Team Members Impacted" },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">AI Solutions Architect</span>
          </motion.div>
          ...
          >
            Specializing in Conversational AI Agents, Machine Learning, and Enterprise Automation.
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
              {["Python", "LangChain", "OpenAI", "TensorFlow", "React", "FastAPI", "PostgreSQL"].map((tech) => (
